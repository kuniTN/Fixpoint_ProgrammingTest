...
ServerState = []#[ip,state,number of Failure,number of timeouts]
...
def createList(data):
    ...
    ServerState.append([ip_interface(data),-1,0,0])
...
def show():
    ...
    Print("Param of value of timeouts to be judged : " + str(N))
    if LatestCheck != '0':
